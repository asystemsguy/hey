...
func (b *Work) makeRequest(c *http.Client, num int) {
	s := now()
	var size int64
	var code int
...
func (b *Work) runWorker(client *http.Client, n int, c int) {
